        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35 }} className="w-full max-w-sm relative">
          <div className="bg-[#111118] rounded-2xl border border-white/[0.07] shadow-2xl shadow-black/40 p-8">
            ...
            <form onSubmit={(e) => void handleSubmit(onSubmit)(e)} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex justify-end mt-1.5">
                  <Link href="/forgot-password" className="text-xs text-violet-400 hover:text-violet-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 rounded transition-colors">Forgot password?</Link>
                </div>
              </div>
            ...
            <p className="text-sm text-[#9898b4] text-center mt-5">
              ...
              <Link href="/sign-up" className="text-violet-400 font-medium hover:text-violet-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 rounded">Sign up</Link>
            </p>
          </div>
        </motion.div>
      </div>
